...
import Countdown from '../../Common/Countdown'; //引入倒计时组件
  export default{
      data(){
          return{
			  list:[
				{time:'07:50',date:'00-00',detail:'提交借款申请'},
				{time:'07:50',date:'00-00',detail:'资料审核中'},
				{time:'07:50',date:'00-00',detail:'资料审核通过',message:'预付款打款中'},
				{time:'07:50',date:'00-00',detail:'预付款打款成功',message:'预付款已打款到你绑定的银行卡，请注意查收'},
				{time:'07:50',date:'00-00',detail:'尾款打款中',message:'尾款金额：200元',bank:'经专业质检发现与评估价值符合'},
				{time:'07:50',date:'00-00',detail:'已经延期成功，请在期限内完成订单'},
			  ],
			  item:{
